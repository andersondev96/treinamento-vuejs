<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div
        v-else
        class="py-3 pl-5 pr-20 mt-2 rounded bg-brand-gray overflow-x-scroll w-full lg:w-2/3"
      >
      <span v-if="state.hasError">Erro ao carregar o script</span>
      <pre v-else>&lt;script src="https://andersondev96-feedbacker-widget.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>

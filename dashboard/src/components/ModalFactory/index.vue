<template>
  <teleport to='body'>
    <div
      v-if="state.isActive"
      class="fixed top-0 left-0 z-50 flex items-center w-full h-full bg-black bg-opacity-50"
...
const ModalCreateAccount = defineAsyncComponent(() => import('../ModalAccountCreate'))
